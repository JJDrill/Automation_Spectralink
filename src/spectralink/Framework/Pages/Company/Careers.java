 ...
 * @author J. Drill
 */
public class Careers implements iPage {
    private final String page_title = "Careers | Join our Enterprise Mobility Team | Spectralink";
    private final String menu_Company = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[1]/a";
    private final String menu_Company_Careers = "//*[@id=\"tb-megamenu-column-1\"]/ul/li[9]/a";
    private final String page_Load_Check = "//*[@id=\"block-block-68\"]/div[2]/ul/li[6]";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menu_Company_Careers)).click();
