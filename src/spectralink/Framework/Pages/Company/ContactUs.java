 ...
 * @author J. Drill
 */
public class ContactUs implements iPage {
    private final String page_title = "Contact Us | Phones for Enterprise Mobility | Spectralink";
    private final String menu_Company = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[1]/a";
    private final String menu_Company_ContactUs = "//*[@id=\"tb-megamenu-column-1\"]/ul/li[10]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/div/div[1]/div[2]/h3";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menu_Company_ContactUs)).click();
