 ...
 * @author J. Drill
 */
public class Newsroom implements iPage {
    private final String page_title = "Newsrooom | Press Releases | Events | Spectralink";
    private final String menu_Company = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[1]/a";
    private final String menu_Company_Newsroom = "//*[@id=\"tb-megamenu-column-1\"]/ul/li[4]/a";
    private final String page_Load_Check = "//*[@id=\"block-block-62\"]/div";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menu_Company_Newsroom)).click();
