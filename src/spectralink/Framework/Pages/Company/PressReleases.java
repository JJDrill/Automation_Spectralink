 ...
 * @author J. Drill
 */
public class PressReleases implements iPage {
    private final String page_title = "Press Releases | Spectralink";
    private final String menu_Company = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[1]/a";
    private final String menu_Company_PressReleases = "//*[@id=\"tb-megamenu-column-1\"]/ul/li[5]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/div[10]";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menu_Company_PressReleases)).click();
