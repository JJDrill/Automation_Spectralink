 ...
 * @author J. Drill
 */
public class HistoryOfInnovation implements iPage {
    private final String page_title = "History of Innovation | Spectralink";
    private final String menuProducts = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[2]/a";
    private final String menuHistoryOfInnovation = "//*[@id=\"tb-megamenu-column-3\"]/ul/li[2]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/div[2]/div[1]/div/h3";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuHistoryOfInnovation)).click();
