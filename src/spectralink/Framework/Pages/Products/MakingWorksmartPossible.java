 ...
 * @author J. Drill
 */
public class MakingWorksmartPossible implements iPage {
    private final String page_title = "Unified Communications Make WorkSmart Possible | Spectralink";
    private final String menuProducts = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[2]/a";
    private final String menuMakingWorksmartPossible = "//*[@id=\"tb-megamenu-column-3\"]/ul/li[1]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/div[2]/div/div[3]/div/h2";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuMakingWorksmartPossible)).click();
