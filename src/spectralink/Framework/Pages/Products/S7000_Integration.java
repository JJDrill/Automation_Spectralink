 ...
 * @author J. Drill
 */
public class S7000_Integration implements iPage {
    private final String page_title = "DECT Phone Integrations | Spectralink";
    private final String menuProducts = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[2]/a";
    private final String menuS7000Integ = "//*[@id=\"tb-megamenu-column-3\"]/ul/li[7]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/p[7]/a";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuS7000Integ)).click();
