 ...
 * @author J. Drill
 */
public class S8000_Infrastructure implements iPage {
    private final String page_title = "Infrastructure for Wi-Fi Phones | Spectralink";
    private final String menuProducts = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[2]/a";
    private final String menuS8000_Infrastructure = "//*[@id=\"tb-megamenu-column-3\"]/ul/li[11]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/ul/li[2]/a";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuS8000_Infrastructure)).click();
