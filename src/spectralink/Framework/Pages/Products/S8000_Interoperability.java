 ...
 * @author J. Drill
 */
public class S8000_Interoperability implements iPage {
    private final String page_title = "Interoperability for Wi-Fi Phones | Spectralink";
    private final String menuProducts = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[2]/a";
    private final String menuS8000_Interoperability = "//*[@id=\"tb-megamenu-column-3\"]/ul/li[12]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/h3[3]";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuS8000_Interoperability)).click();
