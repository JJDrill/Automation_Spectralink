 ...
 * @author J. Drill
 */
public class S8000_VOIP implements iPage {
    private final String page_title = "Voice Over Wi-Fi Phones for Enterprise Mobility | Spectralink";
    private final String menuProducts = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[2]/a";
    private final String menuS8000_VOIP = "//*[@id=\"tb-megamenu-column-3\"]/ul/li[8]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/h4/a";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuS8000_VOIP)).click();
