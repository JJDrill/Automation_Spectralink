 ...
 * @author J. Drill
 */
public class Design implements iPage {
    private final String page_title = "Design Services for Unified Communications | Spectralink";
    private final String menuServices = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[3]/a";
    private final String menuDesign = "//*[@id=\"tb-megamenu-column-5\"]/ul/li[3]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/h3[2]";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuDesign)).click();
