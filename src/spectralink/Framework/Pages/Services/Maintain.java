 ...
 * @author J. Drill
 */
public class Maintain implements iPage {
    private final String page_title = "Spectralink Maintain | Spectralink";
    private final String menuServices = "//*[@id=\"block-progressive-cms-menu\"]/div/header/div/div/div/div[2]/div/div/div/nav/ul/li[3]/a";
    private final String menuMaintain = "//*[@id=\"tb-megamenu-column-5\"]/ul/li[5]/a";
    private final String page_Load_Check = "//*[@id=\"block-system-main\"]/div/div/div[2]/div[3]/div/h3";
    ...
    public void GoTo(){
        ...
        driver.findElement(By.xpath(menuMaintain)).click();
